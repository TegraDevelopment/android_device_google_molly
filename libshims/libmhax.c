 ...
 *
 * Problems:
 * 1. Molly's GFX libraries were made to work with android L
 ...
 * 
 * Result: GFX libraries works on M, with the help of libmhax.so and a small binary patch to libnvos.so
 */
